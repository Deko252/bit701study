	...
	<c:if test="${sessionScope.loginok != null }">
		...
		<form action="addboard" method="post" enctype="multipart/form-data">
			<table class="table table-boarders" style="width: 500px; margin: 30px 30px">
				...
				<tr>
					<td>
						<textarea name="content" style="width:  100%; height: 100px;" class="formm-control" required="required" placeholder="내용을 입력해 주세요"></textarea>
					</td>
				</tr>
				<tr>
					<td align="center">
						<button type="submit" class="btn btn-outline-success" style="width: 130px;">저장</button>
						<button type="reset" class="btn btn-outline-danger" style="width: 130px;" onclick="location.href='list?currentPage=${currentPage }'">취소</button>
					</td>
				</tr>
			</table>
		</form>
