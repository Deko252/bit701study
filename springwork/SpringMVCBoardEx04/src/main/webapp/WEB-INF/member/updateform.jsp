		...
		<input type="hidden" value="${dto.num }" name="num">
			<table class="table table-bordered">
				...
				<tr>
					...
					style="width: 190px;">
					<br>
					<img id="showimg" width="120" height="150"
				...
				<tr>
					...
					<td>
						...
						class="form-control" style="width: 120px" value="${dto.pass }" readonly="readonly">
					</td>
				</tr>
				<tr>
					...
					<div class="input-group">
						...
						class="form-control" id="email" value="${dto.email }" readonly="readonly">
						</div>
					</td>
				</tr>
				<tr>
