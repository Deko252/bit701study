...
<body>
		        ...
		        <!-- 달력 -->
	    <h2 class="mb-3 animate__animated animate__backInUp" id="h2">진료예약하기</h2>
				...
				<!-- 예약 폼 -->
				<div class="container animate__animated animate__backInUp" id="container">
				    <div class="input-form-backgroud row">
				      <div class="input-form col-md-12 mx-auto">
				        <h2 class="mb-3"></h2>
				        <form class="validation-form" action="empoaction.jsp" method="post" onsubmit="submit();" >
				          <div class="row">
				            <div class="col-md-6 mb-3" style="height: 62px">
				              <label for="name">성함</label>
				              <input type="text" class="form-control" id="name" name="name" placeholder="성함을 입력해 주세요." style="width: 580px;" required>
				          ...
				          <div class="col-md-6 mb-3">
				            <label>생년월일</label>
				            <input type="number" class="form-control" id="p_type" name="birthyear" placeholder="생년월일을 입력해 주세요. Ex)19890101" style="width: 580px;" maxlength="8" oninput="numberMaxLength(this);" required>
				            <div class="invalid-feedback">
				          ...
				          <div class="col-md-6 mb-3">
				            <label>날짜 확인</label>
				            <input type="text" id="period_1" class="form-control" name="empoday" placeholder="날짜를 골라주세요." style="width: 580px;"  readonly="readonly" >
				            <div class="invalid-feedback">
				              날짜를 골라주세요.
				            </div>
				               <p id="resultMsg2"></p>
				          ...
				          <div class="col-md-6 mb-3">
				            ...
				            <input type="number" maxlength="11" oninput="numberMaxLength(this);" class="form-control" id="phoneNumber" name="phone" placeholder="-빼고 입력해 주세요"  style="width: 580px;" required>
				          </div>
...
$("#btnC").click(function() {
	$(".animate__backInUp").addClass("animate__animated animate__zoomOut");
	setTimeout(() => {
	location.href="main.jsp";			
	}, 850);
	setTimeout(() => {
		$(".animate__backInUp").removeClass("animate__animated animate__zoomOut");
	}, 840);
});
