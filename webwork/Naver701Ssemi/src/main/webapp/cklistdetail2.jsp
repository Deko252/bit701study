...
<body>
	<div style="margon: 30px 50px" class="animate__animated animate__backInUp">
		<!-- 이미지 출력할곳 -->
		<img id="showimg"
			style="max-width: 580px;" src="save/<%=dto.getPhoto() %>">
			
		<form method="post" id="fullsize"
			...
			<table class="table table-bordered" >
				...
				<tr>
					...
					<td><input type="text" name="name" class="form-control" placeholder="환자이름을 입력해 주세요."
						style="width: 200px;"required="required" value="<%=dto.getName() %>" readonly="readonly">
					</td>
				</tr>
				<tr>
					<th style="background-color: #ddd" width="100">생년월일</th>
					<td><input type="text" name="birthyear" class="form-control" placeholder="생년월일을 입력해 주세요. Ex)19870605" maxlength="8" oninput="numberMaxLength(this);"
						required="required" style="width: 200px;" value="<%=dto.getBirthyear() %>" readonly="readonly"></td>
				</tr>
				<tr>
					<th style="background-color: #ddd" width="100">전화번호</th>
					<td><input type="text" name="phone" class="form-control" placeholder="-를 빼고 입력해 주세요." maxlength="11" oninput="numberMaxLength(this);"
						required="required" style="width: 200px;" value="0<%=dto.getPhone() %>" readonly="readonly"></td>
				</tr>
				<tr>
					<th style="background-color: #ddd" width="100">병명</th>
					<td><input type="text" name="law" class="form-control" placeholder="병명을 입력해 주세요."
						required="required" style="width: 300px;" value="<%=dto.getLaw() %>" readonly="readonly"></td>
				</tr>
				<tr>
					<th style="background-color: #ddd" width="100">사진(1장)</th>
					<td><input type="text" name="upload" class="form-control" id="myfile" readonly="readonly" value="save/<%=dto.getPhone() %>">
					</td>
				</tr>
				<tr>
					<td colspan="2"><textarea style="width: 100%; height: 450px;"
							name="content" required="required" readonly="readonly"><%=dto.getContent()%></textarea></td>
				</tr>
				<tr>
					<td colspan="2">
