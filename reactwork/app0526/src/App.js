...
import MunjeComponet from "./components/MunjeComponet";
...
function App() {
  ...
  return (
    <div className="App">
        ...
        <option value={8}>MunjeComponet</option>
        </select>
        <br/><br/>

        {idx===1?<OneComponet/>:idx===2?<TwoComponet/>:idx===3?<ThreeComponet/>:idx===4?<FourComponet/>:idx===5?<FiveComponet/>:idx===6?<SixComponet/>:idx===7?<SevenComponet/>:<MunjeComponet/>}
    </div>
  );
}
