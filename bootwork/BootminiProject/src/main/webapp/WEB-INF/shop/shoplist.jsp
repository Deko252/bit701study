...
<body>
<button type="button" class="btn btn-sm btn-outline-danger" onclick="location.href='shopform'" style="margin-bottom: 10px;">상품 등록</button>
...
<table class="table table-bordered">
	...
	<c:forEach var="dto" items="${list }" varStatus="i">
		<tr>
			...
			<td align="right" style="text-align: center; line-height: 59px;">
				<fmt:formatNumber value="${dto.price }" type="currency" currencySymbol="￦" minFractionDigits="0"></fmt:formatNumber>
			</td>
			<td style="text-align: center; line-height: 58px;">
