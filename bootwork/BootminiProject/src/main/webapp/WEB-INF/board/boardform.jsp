...
<div style="width: 450px;">	
	...
	<input type="hidden" name="currentPage" value="${numcurrentPage}">
		<table class="table table-bordered">
			...
			<tr>
				<td colspan="2">
					<textarea required="required" class="form-control" style="width: 100%; height: 130px;" name="content"></textarea>
				</td>
			</tr>
			<tr>
