	...
	<input type="hidden" name="currentPage" value="${currentPage }">
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<input type="password" class="form-control" name="pass" required="required" value="${dto.pass }">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<textarea required="required" class="form-control" style="width: 100%; height: 130px;" name="content">${dto.content }</textarea>
				</td>
			</tr>
			<tr>
